	...
	<form method="POST" enctype="multipart/form-data" style="padding:50px">
	  <div class="mb-3">
		...
		<input type="text" class="form-control" name="ime" value="<?php echo $osoba['ime'] ?>" readonly>
	  </div>
	  <div class="mb-3">
		<label class="form-label">Prezime</label>
		<input type="text" class="form-control" name="prezime" value="<?php echo $osoba['prezime'] ?>" readonly>
	  </div>
	  <div class="mb-3">
	  ...
	  <div class="mb-3">
		...
		<select name="aktivan">
		  ...
		  <option value="0">Deaktiviraj račun</option>
		</select>
	  </div>
	  <div class="mb-3">
